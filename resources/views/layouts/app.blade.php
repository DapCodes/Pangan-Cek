...
<head>
    ...
    <style>
        ...
        .navbar-brand{
          ...
          display:flex;align-items:center;gap:.55rem;text-shadow:0 2px 10px rgba(0,0,0,.25);
        }
        .navbar-brand img{height:28px;width:auto;display:block;}
        .navbar .nav-link{
          color:#fff; font-weight:600; opacity:.9; border-radius:999px;
          padding:.45rem .9rem; transition:all .15s ease;
        }
        .navbar .nav-link:hover{opacity:1; background:rgba(255,255,255,.12);}
        ...
        .card-header{
          ...
          font-weight:700;display:flex;align-items:center;gap:.6rem;padding:.85rem 1rem;color:#f8fafc;
        }

        /* Breadcrumb & title agar kontras */
        .page-title{font-weight:700;color:#f8fafc;}
        .breadcrumb{--bs-breadcrumb-divider:'›';}
        .breadcrumb .breadcrumb-item a{color:#dbeafe;}
        .breadcrumb .breadcrumb-item.active{color:#ffffff;}
        ...
        .form-control:hover,.form-select:hover{background:var(--control-bg-hover);}
        .form-control:focus,.form-select:focus{
          border-color:transparent;
          box-shadow:0 0 0 .2rem var(--ring), 0 0 0 .35rem var(--ring-2);
          background:var(--control-bg-hover); color:var(--control-text);
        }
...
<body>
    <!-- ===== Ornamen halus ===== -->
    <div class="position-fixed w-100 h-100" style="pointer-events:none;inset:0;z-index:-1;opacity:.18;background-image:radial-gradient(#fff 1px,transparent 1px);background-size:18px 18px;"></div>
        ...
        <div class="collapse navbar-collapse" id="topnav">
          <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-1">
            ...
            <li class="nav-item dropdown ms-lg-2">
              <a class="nav-link dropdown-toggle btn-pill" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <i class="bx bx-user-circle me-1"></i>
                {{ auth()->user()->name ?? 'Profil' }}
              </a>
              <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown" style="background:var(--dropdown-bg); border:1px solid var(--dropdown-border);">
                <li>
    ...
    <!-- ====== Footer ====== -->
    <footer class="container-xxl mb-4">
